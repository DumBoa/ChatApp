...
namespace UI
{
    ...
    {
        public event EventHandler PrivateChatClicked;
        ...
        public PrivateChat()
        {
            ...
            RandomizeLabelText();
            this.Click += PrivateChat_Click;
            if (name != null) name.Click += PrivateChat_Click;
            if (status != null) status.Click += PrivateChat_Click;
            Border();
        }
        ...
        {
            PrivateChatClicked?.Invoke(this, EventArgs.Empty);
        }
    }
}